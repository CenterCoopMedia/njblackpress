"""More founder-name Newspapers.com searches for remaining pre-1950 searched_none titles."""
...
NJ = (
    "new jersey", "trenton", "newark", "princeton, new jersey", "camden, new jersey",
    "atlantic city", "bordentown", "montclair", "paterson", "asbury park",
    "freehold", "long branch", "plainfield", "east orange", "ridgewood",
    "hackensack", "woodbury", "bridgewater", "passaic",
)

SEARCHES = [
    (7, "citizen-colored", '"colored newspaper" Princeton', 1905, 1918, "colored"),
    (7, "citizen-dupaur2", '"Du Paur" OR "DuPaur" OR "W. H. DuPaur"', 1900, 1925, "Paur"),
    (45, "apex-morgan", '"Archie J. Morgan" (Apex OR editor OR newspaper)', 1928, 1945, "Morgan"),
    (45, "apex-spencer", '"Sarah Spencer Washington" (Apex News OR newspaper)', 1928, 1945, "Apex"),
    (57, "ironsides-school", '"Bordentown" "Ironsides" (newspaper OR Echo OR school)', 1916, 1956, "Ironsides"),
    (57, "ironsides-manual", '"Manual Training" Bordentown (newspaper OR Echo)', 1916, 1950, "Manual"),
    (3, "camden-cn-green", '"C. N. Green" (editor OR newspaper) Camden', 1914, 1922, "Green"),
    (79, "hiram", '"Hiram Star" OR "Hiram Star-News" Vauxhall', 1945, 1960, "Hiram"),
    (101, "after-hours", '"After Hours" (Negro OR colored OR Newark) magazine', 1947, 1955, "After Hours"),
]
...
def main() -> None:
    ...
    for pid, slug, keyword, y0, y1, find_term in SEARCHES:
        ...
        for card in nj[:2]:
            ...
            time.sleep(0.5)
    (OUT / "q7c-pre1950.json").write_text(json.dumps(report, indent=2), encoding="utf-8")
