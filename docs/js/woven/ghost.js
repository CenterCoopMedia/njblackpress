...
export function createGhost(app, three, model) {
  ...
  async function start() {
    ...
    showCard('open');
    announce(`${model.counts.ghost} publications have no evidence cleared for display in this archive. Their names follow.`);
  ...
  function renderNames(list, all) {
    namesEl.innerHTML = `<div class="g-head"><span>Gaps in the record</span>
