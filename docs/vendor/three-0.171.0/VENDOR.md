...
same-origin. Nothing in Historical notes fetches a CDN at runtime.
...
`docs/historical-notes.html`. If the two disagree, Chrome refuses to load the module. That is
intended.
...
Historical notes does not import.
